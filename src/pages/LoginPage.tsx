        ...
        <div className="relative w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-lg">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
           ...
           <button
              ...
              className="absolute bottom-3 right-3 p-2 text-slate-400 hover:text-sky-600 transition-colors rounded-full hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-sky-500"
